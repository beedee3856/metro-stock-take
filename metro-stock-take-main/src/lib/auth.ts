...
export const PERMISSIONS = {
  ...
  MANAGE_ITEMS: ["ADMINISTRATOR", "SUPERVISOR"],
  IMPORT_ITEMS: ["ADMINISTRATOR", "SUPERVISOR"],
  VIEW_LOCATIONS: ["ADMINISTRATOR", "SUPERVISOR", "STOCK_TAKER", "STORE_MANAGER", "AUDITOR"],
  MANAGE_LOCATIONS: ["ADMINISTRATOR", "SUPERVISOR"],
  ...
  APPROVE_RECOUNT: ["ADMINISTRATOR", "SUPERVISOR", "STORE_MANAGER"],
